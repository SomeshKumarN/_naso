...
public class Constants {
    public static int DEFAULT_METHOD_PRESENCE_COUNT=1;
    public static String TEST_PACKAGE_NAME = "com.testsite.pages";
    public static String NASO_BASE_DIRECTORY = "naso_base";
